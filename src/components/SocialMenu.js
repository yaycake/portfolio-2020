    ...
    return (
        <ul className={styles.socialMenu}>
            <li className={styles.socialMenu__item}>
                <a href="https://github.com/yaycake" title="Grace's Github"><img className={styles.social_icons} src={Github}></img></a>
            </li>
            <li className={styles.socialMenu__item}>
                <a href="https://www.linkedin.com/in/ygrace/" title="Grace's LinkedIn"><img className={styles.social_icons} src={Linkedin}></img></a>
            </li>
            <li className={styles.socialMenu__item}> 
